...
The techniques presented in this paper can be used in various scenarios; one such use of the technique is its implementation into the application layer of a piece of software; this would allow a specific layout of visual content items to be dynamically adapted to different display shapes.
...
In summary, the techniques presented in this paper are capable of efficiently minimising the effect of the identified \acp{DSDI}, but require trade-offs.
