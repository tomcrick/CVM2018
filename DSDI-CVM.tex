...
Previously, the overwhelming majority of systems have utilised rectangular displays; this may soon change with the increasing nature of digital devices to be ubiquitous and pervasive to facilitate human interaction.
...
Furthermore, we present a study focussed on applying the technique to adapt several software applications to several different display shapes.
}
...
The contribution detailed in this paper is a novel technique that allows developers to adapt tabletop software to different display shapes and a study evaluating its potential.
...
The applications used in this study were created by several developers for previous studies in the {\emph{SynergyNet}} project~\cite{higgins2011}.
These were chosen because of their differing methods of organising their visual content items and the varying significance of the layout of their items.
This was important because the study intended to evaluate investigate how the technique would impact the arrangement of both items with and without a significant layout.

\begin{figure*}[h!] 
 \centering
  \includegraphics[width=0.95\textwidth]{figures/Applications.jpeg} %TODO Better image (all in a row).
...
Figure~\ref{fig:apps} shows all four of the applications chosen to be used with the technique for observation.
These four applications were:\\
...
\begin{figure*}[h!] 
 \centering
  \includegraphics[width=0.95\textwidth]{figures/DisplayShapes.jpeg} % TODO Better image (silhouettes all in a row).
  \caption{The different display shapes used in the trial.}
...
Each of the four applications of the technique were run with each of the four display shapes.
...
% TODO Add Data Analysis approach sub-section (Issues 45, 43, 38, 37, 35)
% Use metrics in study:
...
% TODO Restructure to be Results (Issues 47, 44, 40, 37, 33)
