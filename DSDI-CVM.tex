...
This is in keeping with the Section~\ref{sec:background} where the majority of works detailed create non-rectangular displays through showing a region of a rectangular output through approaches like partially covering parts of a display or occluding areas of a projection.
