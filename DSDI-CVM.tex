...
\begin{itemize}
  ...
  To measure impact on the Layout \ac{DSDI} the total distance of items from where they were expected to be with a layout of the same scale but no other deformations.
  ...
  To measure impact on the Scaling \ac{DSDI} the absolute maximum change in scale of all the item in the app is used.
