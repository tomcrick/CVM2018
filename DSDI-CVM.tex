...
\begin{itemize}
  ...
  To measure impact on the Layout \ac{DSDI} the total distance of items from where they were expected to be with a layout of the same scale but no other deformations is measured.
  This value, expressed as a percentage of the width of the the layout's minimal bounding rectangle is used.
