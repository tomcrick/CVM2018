...
At present, software is invariably designed assuming it will be used with a display of a specific shape; however, there is an emerging demand for systems built around interacting with tabletop interfaces to be capable of handling a wide range of potential display shapes.
...
We have entered an era of ubiquitous and pervasive digital systems being designed to fit naturally into their surroundings~\cite{Greenfield2006}, recognising the potential impact on a user's emotion and behaviour~\cite{mostafa-et-al-ai2016}. However, for this to be natural and intuitive, systems are required to be designed around emerging user environments, not by the status quo.
...
If it is important for this alignment to be kept then it is best if the flags are exempt from the position pulling stage of the technique.
...
This allows developers to make informed, user-centered design and implementation decisions on how content should be displayed.

However, developers must consider the limitations of the technique before adopting it.
...
In addition to these, many devices coming to the mass consumer market -- for example, the recent growth of wearable devices -- utilise non-rectangular displays, specifically smart watches~\cite{Jung2016}.
...
With the technique implemented in a tool used to design a wider range of software, its influence can be tested on a wider range of user interfaces with varying complexities in future studies, especially in educational contexts~\cite{McNaughton2017,jg-et-al:cscl2017}.
...
His research interests are interdisciplinary, including data science, intelligent systems, digital public services, software sustainability and computer science education.}
