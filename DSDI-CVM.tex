...
% Use metrics in study (after each stage of the technique) based on DSDIs:
% - Cropping DSDI: % of Items suffering occlusion from display
% - Overlapping DSDI: % of Items suffering occlusion from other items
% - Layout DSDI: change in layout = total distance of items from where they'd expected to be with a layout of the same scale but no other deformations.
% - Display use DSDI: % display shape unused - gathered by drawing a bound rectangle around the content. % area unused = display area outside rectangle / total display area 
% - Scaling DSDI: absolute maximum change in scale of items
% - Warping DSDI: % of items being deformed in a non-uniform manner.
...
% TODO Metrics for Grid Application
...
% TODO Metrics for Simple Map Application
