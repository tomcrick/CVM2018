...
{\normalsize  \bibliography{DSDI-CVM-Refs}}

\Author{bio-james}{James McNaughton}
{is a researcher at Durham University whose research interests include Human-Computer Interaction, natural user interfaces and augmented reality.
James' current work involves investigating the use of emerging interaction technologies in classroom environments.}

\Author{bio-tom}{Tom Crick}
{is a Professor of Computer Science and Public Policy.  Whilst his disciplinary background is in computer science and informatics, Tom's research interests are naturally interdisciplinary and sit at the research/public policy interface.}

\Author{bio-shamus}{Shamus Smith}
{is a Lecturer in Computer Science.
