...
\author[anon1]{Author 1\corref{correspondent}}
\ead{author1@anon}
...
\cortext[correspondent]{Corresponding author. Phone: }
...
Attempts made to resolve this cropping can result in secondary \acp{DSDI}.
 ...
 \begin{figure*}[t]
 \centering
   \includegraphics[width=1\textwidth]{OldClassNamedsdi_flow.jpeg}
...
\begin{figure}[h]
 \centering
   \includegraphics[width=0.45\textwidth]{OldClassNamevirtual_rectangle.jpeg}
...
\begin{figure}[h] 
 \centering
   \includegraphics[width=0.45\textwidth]{OldClassNamevirtual_rectangle_pull_example.jpeg}
...
\begin{figure}[h] 
 \centering
   \includegraphics[width=0.45\textwidth]{OldClassNamevirtual_rectangle_pull_example_detailed.jpeg}
...
\begin{figure*}[t!] 
	\centerline{\includegraphics[width=1\textwidth]{OldClassNamestudy.jpeg}}
...
\begin{figure*}[t!] 
	\centerline{\includegraphics[width=1\textwidth]{OldClassNamegrid_app.jpeg}}
...
\begin{figure*}[t!] 
	\centerline{\includegraphics[width=1\textwidth]{OldClassNamemap_app.jpeg}}
...
\begin{figure*}[t] 
 \centering
   \includegraphics[width=1\textwidth]{OldClassNamesolution_flow.jpeg}
...
\begin{figure}[h]
 \centering
   \includegraphics[width=0.45\textwidth]{OldClassNameprototype.jpeg}
