...
%   noteref={n1},                        % id's of article notes, if any
   email={j.a.mcnaughton@durham.ac.uk, thomas.crick@swansea.ac.uk, Shamus.Smith@newcastle.edu.au}   % All email addresses.
...
\address[id=aff2]{%
  \orgname{Department of Computer Science, Swansea University},
  \street{Singleton Campus},
  \city{Swansea},
  \postcode{SA2 8PP}
  \cny{UK}
}
...
\begin{keyword}
\kwd{Visual content management, irregular displays, screen design, multi-touch surfaces, tabletop displays, ubiquitous computing}
\end{keyword}
...
The remainder of this paper is structured as follows: the \nameref{sec:related} section outlines the current development and drive for non-traditional display shapes with tabletop systems; the \nameref{sec:problem} section identifies the issues arising from the use of different display shapes on a system;
A technique to minimise the influence of the identified issues is proposed in the \nameref{sec:solution} section; in the \nameref{sec:implementation} section we present the development of the technique into a software framework.
