...
The technique presented in this work has several parallels with the guidelines presented in the work of Serrano et al.~\cite{Serrano2016,Serrano2017}.
% TODO Discuss these parallels - e.g. avoid occlusion, etc.
However, this technique deviates from the guidelines presented by Serrano et al. to give developers greater freedom.
...
% TODO  Clearly state intention to carry out a study with the technique in future work.  

% TODO Need to clearly state scope of the technique (i.e. visual content layout) - but state future work could involve further investigation of other issues like usability and readability (again, adding limits to elements of the technique). 

% TODO Reiterate scope was only tabletop displays, future work should look at applying the technique to a wider range of display. How will needing to adhere to restrictions like rotations affect the technique's design and effectiveness?
