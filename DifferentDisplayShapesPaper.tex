...
% Psuedo code showing how this is applied here.
...
% Items are pulled from their centroids to keep calculations simple, ignore the shape and size of the items moved.
...
% More recent SynergyNet references here.
The technique discussed in Section~\ref{sec:solution} was implemented into the 2.1 version of the SynergyNet framework~\cite{AlAgha2010}, a multi-touch software framework intended for use with rectangular tabletop interfaces.
...
% Discussion of vector files here
...
% More here on need for this work
For this reason it is important that software becomes display shape independent.

% Highlight lack of innovation in this area in recent years.
