...
% TODO Discuss the difference between the primary and secondary DSDIs (primary - can happen when displaying content without modification on a different display shape, secondary - can happen when attempting to resolve initial DSDIs) - refer to dsdiFlow. Additionally, note the DSDIs were numbered by the order they were noted by the authors and bare no significance beyond identification. 
