...
% TODO Clearly state that the DSDIs presented are novel.
...
The implmentation of the technique discussed in this manuscript is openly available here: \url{https://github.com/synergynet/synergynet2.5/releases/tag/v0.1}.
...
\begin{figure}[h!]
 \centering
   ...
   An example of the Virtual Projection stage.}
...
\begin{figure}[h!] 
 \centering
   ...
   An example of the Position Pulling stage.}
...
\begin{figure}[h!]
 \centering
   ...
   Detailed view of the information used in Position Pulling.}
...
\begin{figure}[h!] 
 \centering
  ...
  Influence of the implemented technique on SynergyNet's Grid application.}
  \label{fig:gridApp}
\end{figure}
...
\begin{figure}[h!] 
 \centering
  ...
  Influence of the implemented technique on SynergyNet's Simple Map application.}
  \label{fig:mapApp}
\end{figure}
