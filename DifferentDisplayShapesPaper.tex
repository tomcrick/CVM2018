...
Figure~\ref{fig:trial} shows some of the applications in use with the various display shapes applied.
...
We focused on applications in which the layout of content was significant in some way.
